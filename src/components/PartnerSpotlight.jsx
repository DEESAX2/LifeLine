...
const items = [
  { id: 1, video: video4, logo: hosp1, name: 'Korle Bu Teaching Hospital' },
...
const PartnerSpotlight = () => {
  ...
  return (
    <section className="relative bg-black text-white" id="partner-spotlight">
      <video
        key={current} 
        src={video}
        autoPlay
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        ...
        <h3 className="text-2xl font-semibold text-center px-4">{name}</h3>
      </div>
    </section>
  );
};
